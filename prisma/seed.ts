...
async function main() {
  ...
  url.pathname = `${process.env.BUSINESS_SOPHIA}`
  url.searchParams.append(
    'fields',
    'username,followers_count,media{caption,media_url,cover_url,permalink,shortcode,thumbnail_url,insights.metric(engagement,impressions,reach,saved,shares,likes,comments, plays)}',
  )
