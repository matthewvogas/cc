          ...
          <Dialog.Panel
            ...
            <Dialog.Title className=' text-lg font-medium mb-2 text-center mt-16'>
              ...
              <Tab.Panels className=''>
                <p className='text-xs font-medium mx-12 my-4'>Upload screenshots of stories here so they display with your other posts.</p>
                <div className='w-full flex justify-center mb-12'>
                  <ImageUploader campaignFallback={campaignFallback}/>
                </div>
              </Tab.Panels>
          </Dialog.Panel>
        </div>
