            ...
            <div className='flex w-full  flex-row justify-between'>
              ...
              <div className={`flex ${ptMono.className}`}>
                ...
                <div className='dropdown-end dropdown cursor-pointer'>
                  <label
                    tabIndex={0}
                    className={`text-back mx-2  flex cursor-pointer items-center justify-center rounded-full border-2 border-rose-100 bg-transparent px-8 py-2.5 text-lg  font-medium hover:bg-rose-100`}>
                    add new
                    <svg
                      fill='none'
                      viewBox='0 0 26 26'
