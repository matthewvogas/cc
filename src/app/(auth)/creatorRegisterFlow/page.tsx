...
export default function RegisterPage() {
  ...
  const [instagramConectionText, setInstagramConectionText] = useState(
    'Connect to Instagram',
  )
  const [tiktokConectionText, setTiktokConectionText] =
    useState('Connect to TikTok')
